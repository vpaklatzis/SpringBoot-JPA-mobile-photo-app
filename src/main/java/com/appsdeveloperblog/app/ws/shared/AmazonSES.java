...
public class AmazonSES {
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
				...
				+ "<a href='http://localhost:8080/verification-service/email-verification.html?token=$tokenValue'>" // Replace localhost  with aws EC2 instance before deployment
	...
	final String TEXTBODY = "Please verify your email address. "
				...
				+ " http://localhost:8080/verification-service/email-verification.html?token=$tokenValue" // Replace localhost with aws EC2 instance before deployment
				+ " Thank you! And we are waiting for you inside!";
